...
export class TarjetaCreditoComponent implements OnInit {
  ...
  agregarTarjeta(): void{
    ...
    var tarjeta: TarjetaCredito = {
      ...
      numero_tarjeta: String(this.form.get('numeroTarjeta')?.value), 
      fecha_expiracion: this.form.get('fechaExpiracion')?.value, 
  ...
  editarTarjeta(tarjeta: TarjetaCredito): void {
    ...
    this.form.patchValue({
      ...
      numeroTarjeta: parseInt(tarjeta.numero_tarjeta),
      fechaExpiracion: tarjeta.fecha_expiracion,
